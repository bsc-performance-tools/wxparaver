...
////@begin gTimeline content construction
  // Generated by DialogBlocks, Thu 11 May 2017 11:48:58 CEST (unregistered)
...
{
  event.SetText( wxString( _( "Slope (by ")  ) + wxString( _( LABEL_TIMEUNIT[ myWindow->getTimeUnit() ].c_str() ) ) + wxString( _T( ")" ) ) );
}
