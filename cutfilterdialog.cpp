...
////@begin CutFilterDialog content construction
  ...
  wxStaticText* itemStaticText6 = new wxStaticText( itemStaticBoxSizer3->GetStaticBox(), wxID_STATIC, _("Input"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  textCtrlInputTrace = new wxTextCtrl( itemStaticBoxSizer3->GetStaticBox(), ID_TEXTCTRL_CUT_FILTER_INPUT_TRACE, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  fileBrowserButtonInputTrace = new FileBrowserButton( itemStaticBoxSizer3->GetStaticBox(), ID_BUTTON_FILE_BROWSER_INPUT_TRACE, _("Browse"), wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  txtOutputTrace = new wxStaticText( itemStaticBoxSizer3->GetStaticBox(), wxID_STATIC, _("Output"), wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  textCtrlOutputTrace = new wxTextCtrl( itemStaticBoxSizer3->GetStaticBox(), ID_TEXTCTRL_CUT_FILTER_OUTPUT_TRACE, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  fileBrowserButtonOutputTrace = new FileBrowserButton( itemStaticBoxSizer3->GetStaticBox(), ID_BUTTON_FILE_BROWSER_OUTPUT_TRACE, _("Browse"), wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  checkLoadResultingTrace = new wxCheckBox( itemStaticBoxSizer3->GetStaticBox(), ID_CHECKBOX_LOAD_RESULTING_TRACE, _("Load the processed trace"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkRunAppWithResultingTrace = new wxCheckBox( itemStaticBoxSizer3->GetStaticBox(), ID_CHECKBOX_RUN_APP_WITH_RESULTING_TRACE, _("Run application with the processed trace"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  wxStaticText* itemStaticText22 = new wxStaticText( itemStaticBoxSizer20->GetStaticBox(), wxID_STATIC, _("Configuration file"), wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  textCtrlXML = new wxTextCtrl( itemStaticBoxSizer20->GetStaticBox(), ID_TEXTCTRL_CUT_FILTER_XML, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  fileBrowserButtonXML = new FileBrowserButton( itemStaticBoxSizer20->GetStaticBox(), ID_FILEBROWSERBUTTON_CUT_FILTER_XML, _("Browse"), wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  txtExecutionChain = new wxStaticText( itemStaticBoxSizer20->GetStaticBox(), wxID_STATIC, _("Execution chain"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkListExecutionChain = new wxCheckListBox( itemStaticBoxSizer20->GetStaticBox(), ID_CHECKLISTBOX_EXECUTION_CHAIN, wxDefaultPosition, wxDefaultSize, checkListExecutionChainStrings, wxLB_SINGLE|wxLB_NEEDED_SB );
  if (CutFilterDialog::ShowToolTips())
  ...
  buttonUp = new wxBitmapButton( itemStaticBoxSizer20->GetStaticBox(), ID_BITMAPBUTTON_PUSH_UP_FILTER, itemDialog1->GetBitmapResource(wxT("arrow_up.xpm")), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW );
  if (CutFilterDialog::ShowToolTips())
    buttonUp->SetToolTip(_("Select the order of the Cut/Filter tools."));
  itemBoxSizer30->Add(buttonUp, 1, wxGROW|wxTOP, 2);

  buttonDown = new wxBitmapButton( itemStaticBoxSizer20->GetStaticBox(), ID_BITMAPBUTTON_PUSH_DOWN_FILTER, itemDialog1->GetBitmapResource(wxT("arrow_down.xpm")), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW );
  if (CutFilterDialog::ShowToolTips())
  ...
  buttonSaveXml = new wxButton( itemStaticBoxSizer20->GetStaticBox(), ID_BUTTON_SAVE_XML, _("Save..."), wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  notebookTools = new wxNotebook( itemStaticBoxSizer20->GetStaticBox(), ID_NOTEBOOK_CUT_FILTER_OPTIONS, wxDefaultPosition, wxSize(-1, 300), wxBK_DEFAULT );
  ...
  radioCutterCutByTime = new wxRadioButton( itemStaticBoxSizer40->GetStaticBox(), ID_RADIOBUTTON_CUTTER_CUT_BY_TIME, _("Cut by time"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
  ...
  radioCutterCutByTimePercent = new wxRadioButton( itemStaticBoxSizer40->GetStaticBox(), ID_RADIOBUTTON_CUTTER_CUT_BY_PERCENT, _("Cut by time %"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  wxStaticText* itemStaticText47 = new wxStaticText( itemStaticBoxSizer40->GetStaticBox(), wxID_STATIC, _("Begin"), wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  textCutterBeginCut = new wxTextCtrl( itemStaticBoxSizer40->GetStaticBox(), ID_TEXTCTRL_CUTTER_BEGIN_CUT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText50 = new wxStaticText( itemStaticBoxSizer40->GetStaticBox(), wxID_STATIC, _("End"), wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  textCutterEndCut = new wxTextCtrl( itemStaticBoxSizer40->GetStaticBox(), ID_TEXTCTRL_CUTTER_END_CUT, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText53 = new wxStaticText( itemStaticBoxSizer40->GetStaticBox(), wxID_STATIC, _("Tasks"), wxDefaultPosition, wxDefaultSize, 0 );
  itemBoxSizer52->Add(itemStaticText53, 0, wxALIGN_CENTER_VERTICAL|wxALL, 2);

  textCutterTasks = new wxTextCtrl( itemStaticBoxSizer40->GetStaticBox(), ID_TEXTCTRL_CUTTER_TASKS, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  wxStaticLine* itemStaticLine55 = new wxStaticLine( itemStaticBoxSizer40->GetStaticBox(), wxID_STATIC, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
  ...
  buttonCutterSelectRegion = new wxButton( itemStaticBoxSizer40->GetStaticBox(), ID_BUTTON_CUTTER_SELECT_REGION, _("Select Region..."), wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  buttonCutterAllWindow = new wxButton( itemStaticBoxSizer40->GetStaticBox(), ID_BUTTON_CUTTER_ALL_WINDOW, _("All Window"), wxDefaultPosition, wxDefaultSize, 0 );
  buttonCutterAllWindow->Enable(false);
  itemBoxSizer56->Add(buttonCutterAllWindow, 1, wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP, 2);

  buttonCutterAllTrace = new wxButton( itemStaticBoxSizer40->GetStaticBox(), ID_BUTTON_CUTTER_ALL_TRACE, _("All Trace"), wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  checkCutterUseOriginalTime = new wxCheckBox( itemStaticBoxSizer60->GetStaticBox(), ID_CHECKBOX_CHECK_CUTTER_ORIGINAL_TIME, _("Use original time"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkCutterRemoveFirstState = new wxCheckBox( itemStaticBoxSizer60->GetStaticBox(), ID_CHECKBOX_CUTTER_REMOVE_FIRST_STATE, _("Remove first state"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkCutterDontBreakStates = new wxCheckBox( itemStaticBoxSizer60->GetStaticBox(), ID_CHECKBOX_CUTTER_BREAK_STATES, _("Don't break states"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkCutterRemoveLastState = new wxCheckBox( itemStaticBoxSizer60->GetStaticBox(), ID_CHECKBOX_CUTTER_REMOVE_LAST_STATE, _("Remove last state"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkCutterKeepEvents = new wxCheckBox( itemStaticBoxSizer60->GetStaticBox(), ID_CHECKBOX_CUTTER_KEEP_EVENTS, _("Keep boundary events"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  wxStaticText* itemStaticText70 = new wxStaticText( itemStaticBoxSizer69->GetStaticBox(), wxID_STATIC, _("Maximum trace size"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE );
  itemStaticBoxSizer69->Add(itemStaticText70, 1, wxGROW|wxALL, 2);

  textCutterMaximumTraceSize = new wxSpinCtrl( itemStaticBoxSizer69->GetStaticBox(), ID_SPINCTRL_CUTTER_MAXIMUM_SIZE, wxT("0"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 1000000, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText72 = new wxStaticText( itemStaticBoxSizer69->GetStaticBox(), wxID_STATIC, _("MB"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkFilterDiscardStateRecords = new wxCheckBox( itemStaticBoxSizer75->GetStaticBox(), ID_CHECKBOX_FILTER_DISCARD_STATE, _("State"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkFilterDiscardEventRecords = new wxCheckBox( itemStaticBoxSizer75->GetStaticBox(), ID_CHECKBOX_FILTER_DISCARD_EVENT, _("Event"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkFilterDiscardCommunicationRecords = new wxCheckBox( itemStaticBoxSizer75->GetStaticBox(), ID_CHECKBOX_FILTER_DISCARD_COMMUNICATION, _("Communication"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkListFilterStates = new wxCheckListBox( itemStaticBoxSizer79->GetStaticBox(), ID_CHECKLISTBOX_FILTER_STATES, wxDefaultPosition, wxSize(-1, 100), checkListFilterStatesStrings, wxLB_SINGLE );
  if (CutFilterDialog::ShowToolTips())
  ...
  buttonFilterSelectAll = new wxButton( itemStaticBoxSizer79->GetStaticBox(), ID_BUTTON_FILTER_SELECT_ALL, _("Select all"), wxDefaultPosition, wxDefaultSize, 0 );
  itemBoxSizer81->Add(buttonFilterSelectAll, 0, wxALIGN_CENTER_HORIZONTAL|wxTOP|wxBOTTOM, 5);

  buttonFilterUnselectAll = new wxButton( itemStaticBoxSizer79->GetStaticBox(), ID_BUTTON_FILTER_UNSELECT_ALL, _("Unselect all"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  labelFilterMinBurstTime = new wxStaticText( itemStaticBoxSizer79->GetStaticBox(), wxID_STATIC, _("Min. burst time"), wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  textFilterMinBurstTime = new wxTextCtrl( itemStaticBoxSizer79->GetStaticBox(), ID_TEXTCTRL_FILTER_MIN_BURST_TIME, _("0"), wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  listboxFilterEvents = new wxListBox( itemStaticBoxSizer87->GetStaticBox(), ID_LISTBOX_FILTER_EVENTS, wxDefaultPosition, wxDefaultSize, listboxFilterEventsStrings, wxLB_SINGLE );
  if (CutFilterDialog::ShowToolTips())
  ...
  buttonFilterAdd = new wxButton( itemStaticBoxSizer87->GetStaticBox(), ID_BUTTON_FILTER_ADD, _("Add"), wxDefaultPosition, wxDefaultSize, 0 );
  itemBoxSizer89->Add(buttonFilterAdd, 0, wxALIGN_CENTER_HORIZONTAL|wxTOP|wxBOTTOM, 5);

  buttonFilterDelete = new wxButton( itemStaticBoxSizer87->GetStaticBox(), ID_BUTTON_FILTER_DELETE, _("Delete"), wxDefaultPosition, wxDefaultSize, 0 );
  itemBoxSizer89->Add(buttonFilterDelete, 0, wxALIGN_CENTER_HORIZONTAL|wxTOP|wxBOTTOM, 5);

  checkFilterDiscardListedEvents = new wxCheckBox( itemStaticBoxSizer87->GetStaticBox(), ID_CHECKBOX_FILTER_DISCARD_LISTED_EVENTS, _("Discard"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  staticTextFilterSize = new wxStaticText( itemStaticBoxSizer93->GetStaticBox(), wxID_STATIC, _("Minimum size "), wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  textFilterSize = new wxSpinCtrl( itemStaticBoxSizer93->GetStaticBox(), ID_SPINCTRL_FILTER_SIZE, wxT("0"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100000000, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  staticTextFilterSizeUnit = new wxStaticText( itemStaticBoxSizer93->GetStaticBox(), wxID_STATIC, _("Bytes"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  radioSCOnIntervals = new wxRadioButton( itemStaticBoxSizer99->GetStaticBox(), ID_RADIOBUTTON_SC_ON_INTERVALS, _("On intervals"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
  ...
  radioSCOnStates = new wxRadioButton( itemStaticBoxSizer99->GetStaticBox(), ID_RADIOBUTTON_SC_ON_STATES, _("On states"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  wxStaticLine* itemStaticLine103 = new wxStaticLine( itemStaticBoxSizer99->GetStaticBox(), wxID_STATIC, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
  ...
  staticTextSCSamplingInterval = new wxStaticText( itemStaticBoxSizer99->GetStaticBox(), wxID_STATIC, _("Sampling Interval (ns)"), wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  textSCSamplingInterval = new wxTextCtrl( itemStaticBoxSizer99->GetStaticBox(), ID_TEXTCTRL_SC_SAMPLING_INTERVAL, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  staticTextSCMinimumBurstTime = new wxStaticText( itemStaticBoxSizer99->GetStaticBox(), wxID_STATIC, _("Min Burst Time (ns)"), wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  textSCMinimumBurstTime = new wxTextCtrl( itemStaticBoxSizer99->GetStaticBox(), ID_TEXTCTRL_SC_MINIMUM_BURST_TIME, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
  if (CutFilterDialog::ShowToolTips())
  ...
  listSCSelectedEvents = new wxListBox( itemStaticBoxSizer111->GetStaticBox(), ID_CHECKLISTBOX_SC_SELECTED_EVENTS, wxDefaultPosition, wxDefaultSize, listSCSelectedEventsStrings, wxLB_SINGLE );
  if (CutFilterDialog::ShowToolTips())
  ...
  buttonSCSelectedEventsAdd = new wxButton( itemStaticBoxSizer111->GetStaticBox(), ID_BUTTON_SC_SELECTED_EVENTS_ADD, _("Add"), wxDefaultPosition, wxDefaultSize, 0 );
  itemBoxSizer114->Add(buttonSCSelectedEventsAdd, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5);

  buttonSCSelectedEventsDelete = new wxButton( itemStaticBoxSizer111->GetStaticBox(), ID_BUTTON_SC_SELECTED_EVENTS_DELETE, _("Delete"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  radioSCCountEvents = new wxRadioButton( itemStaticBoxSizer117->GetStaticBox(), ID_RADIOBUTTON_SC_COUNT_EVENTS, _("Count events"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
  ...
  radioSCAccumulateValues = new wxRadioButton( itemStaticBoxSizer117->GetStaticBox(), ID_RADIOBUTTON8, _("Accumulate values"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  wxStaticLine* itemStaticLine122 = new wxStaticLine( itemStaticBoxSizer117->GetStaticBox(), wxID_STATIC, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
  ...
  checkSCRemoveStates = new wxCheckBox( itemStaticBoxSizer117->GetStaticBox(), ID_CHECKBOX_SC_REMOVE_STATES, _("Remove states"), wxDefaultPosition, wxDefaultSize, 0 );
  checkSCRemoveStates->SetValue(false);
  itemGridSizer123->Add(checkSCRemoveStates, 1, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 2);

  checkSCSummarizeUseful = new wxCheckBox( itemStaticBoxSizer117->GetStaticBox(), ID_CHECKBOX_SC_SUMMARIZE_USEFUL, _("Summarize useful"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkSCGlobalCounters = new wxCheckBox( itemStaticBoxSizer117->GetStaticBox(), ID_CHECKBOX_SC_GLOBAL_COUNTERS, _("Global counters"), wxDefaultPosition, wxDefaultSize, 0 );
  checkSCGlobalCounters->SetValue(false);
  itemGridSizer123->Add(checkSCGlobalCounters, 1, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 2);

  checkSCOnlyInBurstsCounting = new wxCheckBox( itemStaticBoxSizer117->GetStaticBox(), ID_CHECKBOX_SC_ONLY_IN_BURSTS_COUNTING, _("Only in bursts counting"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  listSCKeepEvents = new wxListBox( itemStaticBoxSizer128->GetStaticBox(), ID_LISTBOX_SC_KEEP_EVENTS, wxDefaultPosition, wxDefaultSize, listSCKeepEventsStrings, wxLB_SINGLE );
  ...
  buttonSCKeepEventsAdd = new wxButton( itemStaticBoxSizer128->GetStaticBox(), ID_BUTTON_SC_KEEP_EVENTS_ADD, _("Add"), wxDefaultPosition, wxDefaultSize, 0 );
  itemBoxSizer130->Add(buttonSCKeepEventsAdd, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5);

  buttonSCKeepEventsDelete = new wxButton( itemStaticBoxSizer128->GetStaticBox(), ID_BUTTON_SC_KEEP_EVENTS_DELETE, _("Delete"), wxDefaultPosition, wxDefaultSize, 0 );
