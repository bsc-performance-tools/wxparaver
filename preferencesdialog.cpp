...
////@begin PreferencesDialog content construction
  ...
  globalPanel = new wxPanel( GetBookCtrl(), ID_PREFERENCES_GLOBAL, wxDefaultPosition, wxDefaultSize, wxSUNKEN_BORDER|wxTAB_TRAVERSAL );
  wxBoxSizer* itemBoxSizer3 = new wxBoxSizer(wxVERTICAL);
  globalPanel->SetSizer(itemBoxSizer3);

  wxStaticBox* itemStaticBoxSizer4Static = new wxStaticBox(globalPanel, wxID_ANY, _("  Trace  "));
  wxStaticBoxSizer* itemStaticBoxSizer4 = new wxStaticBoxSizer(itemStaticBoxSizer4Static, wxVERTICAL);
  itemBoxSizer3->Add(itemStaticBoxSizer4, 0, wxGROW|wxALL, 5);
  checkGlobalFillStateGaps = new wxCheckBox( globalPanel, ID_PREFERENCES_GLOBAL_FILLGAPS, _("Fill State gaps with IDLE State"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  wxStaticText* itemStaticText7 = new wxStaticText( globalPanel, wxID_STATIC, _("Maximum loadable trace size (MB)"), wxDefaultPosition, wxDefaultSize, 0 );
  itemBoxSizer6->Add(itemStaticText7, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

  txtMaximumTraceSize = new wxSpinCtrl( globalPanel, ID_TEXTCTRL_MAXIMUM_LOADABLE_TRACE_SIZE, _T("0"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 5000, 0 );
  itemBoxSizer6->Add(txtMaximumTraceSize, 1, wxALIGN_CENTER_VERTICAL|wxALL, 5);

  wxStaticBox* itemStaticBoxSizer9Static = new wxStaticBox(globalPanel, wxID_ANY, _("  Default directories  "));
  ...
  wxStaticText* itemStaticText11 = new wxStaticText( globalPanel, wxID_STATIC, _("Traces"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  textCtrlTrace = new wxTextCtrl( globalPanel, ID_TEXTCTRL_DEFAULT_TRACE, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  dirBrowserButtonTrace = new DirBrowserButton( globalPanel, ID_BUTTON_DIR_BROWSER_TRACE, _("Browse"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText15 = new wxStaticText( globalPanel, wxID_STATIC, _("CFGs"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  textCtrlCFG = new wxTextCtrl( globalPanel, ID_TEXTCTRL_DEFAULT_CFGS, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  dirBrowserButtonCFG = new DirBrowserButton( globalPanel, ID_DIRBROWSERBUTTON_DEFAULT_CFGS, _("Browse"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText19 = new wxStaticText( globalPanel, wxID_STATIC, _("Filters XML"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  textCtrlXML = new wxTextCtrl( globalPanel, ID_TEXTCTRL_DEFAULT_XMLS, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
    textCtrlXML->SetToolTip(_("Base path to Cut/Filters XML."));
  itemBoxSizer18->Add(textCtrlXML, 5, wxALIGN_CENTER_VERTICAL|wxALL, 5);

  dirBrowserButtonXML = new DirBrowserButton( globalPanel, ID_BUTTON_DEFAULT_XMLS, _("Browse"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText23 = new wxStaticText( globalPanel, wxID_STATIC, _("Tutorials root"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  textCtrlTutorials = new wxTextCtrl( globalPanel, ID_TEXTCTRL_DEFAULT_TUTORIALS, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  dirBrowserButtonTutorials = new DirBrowserButton( globalPanel, ID_DIRBROWSERBUTTON_DEFAULT_TUTORIALS, _("Browse"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText27 = new wxStaticText( globalPanel, wxID_STATIC, _("Tmp dir"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  textCtrlTmp = new wxTextCtrl( globalPanel, ID_TEXTCTRL_DEFAULT_TMP, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  dirBrowserButtonTmp = new DirBrowserButton( globalPanel, ID_DIRBROWSERBUTTON_DEFAULT_TMP, _("Browse"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticBox* itemStaticBoxSizer30Static = new wxStaticBox(globalPanel, wxID_ANY, _("  Behaviour  "));
  ...
  checkGlobalSingleInstance = new wxCheckBox( globalPanel, ID_PREFERENCES_GLOBAL_SINGLE_INSTANCE, _("Allow only one running instance"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  wxStaticText* itemStaticText33 = new wxStaticText( globalPanel, wxID_STATIC, _("Automatically save session every"), wxDefaultPosition, wxDefaultSize, 0 );
  itemBoxSizer32->Add(itemStaticText33, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

  spinSessionTime = new wxSpinCtrl( globalPanel, ID_PREFERENCES_GLOBAL_TIME_SESSION, _T("0"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 0 );
  itemBoxSizer32->Add(spinSessionTime, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

  wxStaticText* itemStaticText35 = new wxStaticText( globalPanel, wxID_STATIC, _("minutes"), wxDefaultPosition, wxDefaultSize, 0 );
  itemBoxSizer32->Add(itemStaticText35, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

  GetBookCtrl()->AddPage(globalPanel, _("Global"));

  timelinePanel = new wxPanel( GetBookCtrl(), ID_PREFERENCES_TIMELINE, wxDefaultPosition, wxDefaultSize, wxSUNKEN_BORDER|wxTAB_TRAVERSAL );
  wxBoxSizer* itemBoxSizer37 = new wxBoxSizer(wxHORIZONTAL);
  timelinePanel->SetSizer(itemBoxSizer37);

  wxBoxSizer* itemBoxSizer38 = new wxBoxSizer(wxVERTICAL);
  itemBoxSizer37->Add(itemBoxSizer38, 3, wxGROW|wxTOP, 5);
  wxStaticBox* itemStaticBoxSizer39Static = new wxStaticBox(timelinePanel, wxID_STATIC, _("  Name Format  "));
  ...
  wxStaticText* itemStaticText41 = new wxStaticText( timelinePanel, wxID_STATIC, _("Prefix"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  txtTimelineNameFormatPrefix = new wxTextCtrl( timelinePanel, ID_PREFERENCES_TIMELINE_NAME_PREFIX, _("New Window # %N"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  wxStaticText* itemStaticText44 = new wxStaticText( timelinePanel, wxID_STATIC, _("Full"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  txtTimelineNameFormatFull = new wxTextCtrl( timelinePanel, ID_PREFERENCES_TIMELINE_NAME_FULL, _("%P @ %T"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  wxStaticBox* itemStaticBoxSizer46Static = new wxStaticBox(timelinePanel, wxID_ANY, _("  Rendering Options  "));
  ...
  checkTimelineCommunicationLines = new wxCheckBox( timelinePanel, ID_PREFERENCES_TIMELINE_COMMUNICATION_LINES, _("Communication Lines"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkTimelineEventLines = new wxCheckBox( timelinePanel, ID_PREFERENCES_TIMELINE_EVENT_LINES, _("Event Flags"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  wxStaticText* itemStaticText50 = new wxStaticText( timelinePanel, wxID_STATIC, _("Color"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  choiceTimelineColor = new wxChoice( timelinePanel, ID_PREFERENCES_TIMELINE_COLOR, wxDefaultPosition, wxDefaultSize, choiceTimelineColorStrings, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText53 = new wxStaticText( timelinePanel, wxID_STATIC, _("Gradient Function"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  choiceTimelineGradientFunction = new wxChoice( timelinePanel, ID_PREFERENCES_TIMELINE_GRADIENT, wxDefaultPosition, wxDefaultSize, choiceTimelineGradientFunctionStrings, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText56 = new wxStaticText( timelinePanel, wxID_STATIC, _("Drawmode Time"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  choiceTimelineDrawmodeTime = new wxChoice( timelinePanel, ID_PREFERENCES_TIMELINE_DRAWMODE_TIME, wxDefaultPosition, wxDefaultSize, choiceTimelineDrawmodeTimeStrings, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText59 = new wxStaticText( timelinePanel, wxID_STATIC, _("Drawmode Objects"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  choiceTimelineDrawmodeObjects = new wxChoice( timelinePanel, ID_PREFERENCES_TIMELINE_DRAWMODE_OBJECTS, wxDefaultPosition, wxDefaultSize, choiceTimelineDrawmodeObjectsStrings, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText62 = new wxStaticText( timelinePanel, wxID_STATIC, _("Pixel Size"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  choiceTimelinePixelSize = new wxChoice( timelinePanel, ID_PREFERENCES_TIMELINE_PIXEL_SIZE, wxDefaultPosition, wxDefaultSize, choiceTimelinePixelSizeStrings, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText65 = new wxStaticText( timelinePanel, wxID_STATIC, _("Labels to draw"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  choiceTimelineLabels = new wxChoice( timelinePanel, ID_PREFERENCES_TIMELINE_LABELS, wxDefaultPosition, wxDefaultSize, choiceTimelineLabelsStrings, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText68 = new wxStaticText( timelinePanel, wxID_STATIC, _("Object Axis Position"), wxDefaultPosition, wxDefaultSize, 0 );
  itemBoxSizer67->Add(itemStaticText68, 1, wxALIGN_CENTER_VERTICAL|wxALL, 5);

  wxArrayString choiceTimelineObjectAxisStrings;
  choiceTimelineObjectAxis = new wxChoice( timelinePanel, ID_PREFERENCES_TIMELINE_OBJECT_AXIS, wxDefaultPosition, wxDefaultSize, choiceTimelineObjectAxisStrings, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticBox* itemStaticBoxSizer71Static = new wxStaticBox(timelinePanel, wxID_ANY, _("  What / Where  "));
  ...
  checkTimelineWWSemantic = new wxCheckBox( timelinePanel, ID_CHECKBOX_TIMELINE_WW_SEMANTIC, _("Semantic"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkTimelineWWEvents = new wxCheckBox( timelinePanel, ID_CHECKBOX_TIMELINE_WW_EVENTS, _("Events"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkTimelineWWCommunications = new wxCheckBox( timelinePanel, ID_CHECKBOX_TIMELINE_WW_COMMUNICATIONS, _("Communications"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkTimelineWWPreviousNext = new wxCheckBox( timelinePanel, ID_CHECKBOX_TIMELINE_WW_PREVIOUS_NEXT, _("Previous / Next"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkTimelineWWText = new wxCheckBox( timelinePanel, ID_CHECKBOX_TIMELINE_WW_TEXT, _("Text"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  wxStaticText* itemStaticText78 = new wxStaticText( timelinePanel, wxID_STATIC, _("Precision"), wxDefaultPosition, wxDefaultSize, 0 );
  itemBoxSizer77->Add(itemStaticText78, 2, wxALIGN_CENTER_VERTICAL, 5);

  txtTimelineWWPrecision = new wxSpinCtrl( timelinePanel, ID_PREFERENCES_TIMELINE_WW_PRECISION, _T("2"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 10, 2 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText81 = new wxStaticText( timelinePanel, wxID_STATIC, _("Event pixels"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  txtTimelineWWEventPixels = new wxSpinCtrl( timelinePanel, ID_PREFERENCES_TIMELINE_WW_EVENT_PIXELS, _T("0"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 0 );
  ...
  wxStaticBox* itemStaticBoxSizer83Static = new wxStaticBox(timelinePanel, wxID_ANY, _("  Default Save Options  "));
  ...
  wxStaticText* itemStaticText85 = new wxStaticText( timelinePanel, wxID_STATIC, _("Image as"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  choiceTimelineSaveImageFormat = new wxChoice( timelinePanel, ID_PREFERENCES_TIMELINE_SAVE_AS_IMAGE, wxDefaultPosition, wxDefaultSize, choiceTimelineSaveImageFormatStrings, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText88 = new wxStaticText( timelinePanel, wxID_STATIC, _("Text as"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  choiceTimelineSaveTextFormat = new wxChoice( timelinePanel, ID_PREFERENCES_TIMELINE_SAVE_AS_TEXT, wxDefaultPosition, wxDefaultSize, choiceTimelineSaveTextFormatStrings, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  GetBookCtrl()->AddPage(timelinePanel, _("Timeline"));

  histogramPanel = new wxPanel( GetBookCtrl(), ID_PREFERENCES_HISTOGRAM, wxDefaultPosition, wxDefaultSize, wxSUNKEN_BORDER|wxTAB_TRAVERSAL );
  wxBoxSizer* itemBoxSizer91 = new wxBoxSizer(wxHORIZONTAL);
  histogramPanel->SetSizer(itemBoxSizer91);

  wxBoxSizer* itemBoxSizer92 = new wxBoxSizer(wxVERTICAL);
  itemBoxSizer91->Add(itemBoxSizer92, 3, wxGROW|wxTOP, 5);
  wxStaticBox* itemStaticBoxSizer93Static = new wxStaticBox(histogramPanel, wxID_STATIC, _("  Name Format  "));
  ...
  wxStaticText* itemStaticText95 = new wxStaticText( histogramPanel, wxID_STATIC, _("Prefix"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  txtHistogramNameFormatPrefix = new wxTextCtrl( histogramPanel, ID_PREFERENCES_HISTOGRAM_NAME_PREFIX, _("New Histogram # %N"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  wxStaticText* itemStaticText98 = new wxStaticText( histogramPanel, wxID_STATIC, _("Full"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  txtHistogramNameFormatFull = new wxTextCtrl( histogramPanel, ID_PREFERENCES_HISTOGRAM_NAME_FULL, _("%P @ %T"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  wxStaticBox* itemStaticBoxSizer100Static = new wxStaticBox(histogramPanel, wxID_ANY, _("  Matrix Options  "));
  ...
  checkHistogramZoom = new wxCheckBox( histogramPanel, ID_PREFERENCES_HISTOGRAM_MATRIX_ZOOM, _("Zoom View as default"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkHistogramHorizontal = new wxCheckBox( histogramPanel, ID_PREFERENCES_HISTOGRAM_MATRIX_HORIZONTAL, _("Horizontal disposition"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkHistogramHideEmpty = new wxCheckBox( histogramPanel, ID_PREFERENCES_HISTOGRAM_MATRIX_HIDE_EMPTY, _("Hide empty columns"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkHistogramShowGradient = new wxCheckBox( histogramPanel, ID_PREFERENCES_HISTOGRAM_MATRIX_GRADIENT, _("Show Gradient Colors"), wxDefaultPosition, wxDefaultSize, 0 );
  checkHistogramShowGradient->SetValue(true);
  itemStaticBoxSizer100->Add(checkHistogramShowGradient, 0, wxGROW, 5);

  checkHistogramLabelsColor = new wxCheckBox( histogramPanel, ID_PREFERENCES_HISTOGRAM_MATRIX_LABELS_COLOR, _("Labels color"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  wxStaticText* itemStaticText107 = new wxStaticText( histogramPanel, wxID_STATIC, _("Gradient Function"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  choiceHistogramGradientFunction = new wxChoice( histogramPanel, ID_PREFERENCES_HISTOGRAM_MATRIX_GRADIENT_FUNCTION, wxDefaultPosition, wxDefaultSize, choiceHistogramGradientFunctionStrings, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText110 = new wxStaticText( histogramPanel, wxID_STATIC, _("Drawmode Semantic"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  choiceHistogramDrawmodeSemantic = new wxChoice( histogramPanel, ID_PREFERENCES_HISTOGRAM_MATRIX_DRAWMODE_SEMANTIC, wxDefaultPosition, wxDefaultSize, choiceHistogramDrawmodeSemanticStrings, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText113 = new wxStaticText( histogramPanel, wxID_STATIC, _("Drawmode Objects"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  choiceHistogramDrawmodeObjects = new wxChoice( histogramPanel, ID_PREFERENCES_HISTOGRAM_MATRIX_DRAWMODE_OBJECTS, wxDefaultPosition, wxDefaultSize, choiceHistogramDrawmodeObjectsStrings, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticBox* itemStaticBoxSizer116Static = new wxStaticBox(histogramPanel, wxID_ANY, _("  Cell Format  "));
  ...
  checkHistogramScientificNotation = new wxCheckBox( histogramPanel, ID_PREFERENCES_HISTOGRAM_SCIENTIFIC_NOTATION, _("Scientific Notation"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkHistogramThousandsSeparator = new wxCheckBox( histogramPanel, ID_PREFERENCES_HISTOGRAM_THOUSANDS_SEPARATOR, _("Thousands Separator"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkHistogramShowUnits = new wxCheckBox( histogramPanel, ID_PREFERENCES_HISTOGRAM_SHOW_UNITS, _("Show Units"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  wxStaticText* itemStaticText121 = new wxStaticText( histogramPanel, wxID_STATIC, _("Precision"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  txtHistogramPrecision = new wxSpinCtrl( histogramPanel, ID_PREFERENCES_HISTOGRAM_PRECISION, _T("2"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 10, 2 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticBox* itemStaticBoxSizer123Static = new wxStaticBox(histogramPanel, wxID_ANY, _("  Compute Options  "));
  ...
  checkHistogramAutofitControlScale = new wxCheckBox( histogramPanel, ID_PREFERENCES_HISTOGRAM_AUTOFIT_CONTROL, _("Autofit Control Scale"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkHistogramAutofit3DScale = new wxCheckBox( histogramPanel, ID_PREFERENCES_HISTOGRAM_AUTOFIT_3D, _("Autofit 3D Scale"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  checkHistogramAutofitDataGradient = new wxCheckBox( histogramPanel, ID_PREFERENCES_HISTOGRAM_AUTOFIT_DATA_GRADIENT, _("Autofit Data Gradient"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  wxStaticText* itemStaticText128 = new wxStaticText( histogramPanel, wxID_STATIC, _("Columns"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  txtHistogramNumColumns = new wxSpinCtrl( histogramPanel, ID_PREFERENCES_HISTOGRAM_NUMCOLUMNS, _T("20"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 1, 256, 20 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticBox* itemStaticBoxSizer130Static = new wxStaticBox(histogramPanel, wxID_ANY, _("  Default Save Options  "));
  ...
  wxStaticText* itemStaticText132 = new wxStaticText( histogramPanel, wxID_STATIC, _("Image as"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  choiceHistogramSaveImageFormat = new wxChoice( histogramPanel, ID_PREFERENCES_HISTOGRAM_SAVE_IMAGE_FORMAT, wxDefaultPosition, wxDefaultSize, choiceHistogramSaveImageFormatStrings, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText135 = new wxStaticText( histogramPanel, wxID_STATIC, _("Text as"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  choiceHistogramSaveTextFormat = new wxChoice( histogramPanel, ID_PREFERENCES_HISTOGRAM_SAVE_TXT_FORMAT, wxDefaultPosition, wxDefaultSize, choiceHistogramSaveTextFormatStrings, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  GetBookCtrl()->AddPage(histogramPanel, _("Histogram"));

  colorPanel = new wxPanel( GetBookCtrl(), ID_PREFERENCES_COLOR, wxDefaultPosition, wxDefaultSize, wxSUNKEN_BORDER|wxTAB_TRAVERSAL );
  wxBoxSizer* itemBoxSizer138 = new wxBoxSizer(wxVERTICAL);
  colorPanel->SetSizer(itemBoxSizer138);

  wxStaticBox* itemStaticBoxSizer139Static = new wxStaticBox(colorPanel, wxID_ANY, _("  Timeline  "));
  ...
  wxStaticText* itemStaticText141 = new wxStaticText( colorPanel, wxID_STATIC, _("Background"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  colourPickerBackground = new wxColourPickerCtrl( colorPanel, ID_COLOURPICKER_BACKGROUND, wxColour(0, 0, 0), wxDefaultPosition, wxDefaultSize, wxCLRP_DEFAULT_STYLE|wxCLRP_USE_TEXTCTRL|wxCLRP_SHOW_LABEL );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText144 = new wxStaticText( colorPanel, wxID_STATIC, _("Foreground"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  colourPickerAxis = new wxColourPickerCtrl( colorPanel, ID_COLOURPICKER_AXIS, wxColour(255, 255, 255), wxDefaultPosition, wxDefaultSize, wxCLRP_DEFAULT_STYLE|wxCLRP_USE_TEXTCTRL|wxCLRP_SHOW_LABEL );
  if (PreferencesDialog::ShowToolTips())
  ...
  checkZero = new wxCheckBox( colorPanel, wxID_STATIC, _("Semantic zero"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  colourPickerZero = new wxColourPickerCtrl( colorPanel, ID_COLOURPICKER_ZERO, wxColour(0, 0, 0), wxDefaultPosition, wxDefaultSize, wxCLRP_DEFAULT_STYLE|wxCLRP_USE_TEXTCTRL|wxCLRP_SHOW_LABEL );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText150 = new wxStaticText( colorPanel, wxID_STATIC, _("Logical comms."), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  colourPickerLogical = new wxColourPickerCtrl( colorPanel, ID_COLOURPICKER_LOGICAL, wxColour(255, 255, 0), wxDefaultPosition, wxDefaultSize, wxCLRP_DEFAULT_STYLE|wxCLRP_USE_TEXTCTRL|wxCLRP_SHOW_LABEL );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText153 = new wxStaticText( colorPanel, wxID_STATIC, _("Physical comms."), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  colourPickerPhysical = new wxColourPickerCtrl( colorPanel, ID_COLOURPICKER_PHYSICAL, wxColour(255, 0, 0), wxDefaultPosition, wxDefaultSize, wxCLRP_DEFAULT_STYLE|wxCLRP_USE_TEXTCTRL|wxCLRP_SHOW_LABEL );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxButton* itemButton155 = new wxButton( colorPanel, ID_BUTTON_DEFAULT_TIMELINE, _("Default"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticBox* itemStaticBoxSizer156Static = new wxStaticBox(colorPanel, wxID_ANY, _("  Gradient  "));
  ...
  wxStaticText* itemStaticText158 = new wxStaticText( colorPanel, wxID_STATIC, _("Begin"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  colourPickerGradientBegin = new wxColourPickerCtrl( colorPanel, ID_COLOURPICKER_GRADBEGIN, wxColour(0, 255, 0), wxDefaultPosition, wxDefaultSize, wxCLRP_DEFAULT_STYLE|wxCLRP_USE_TEXTCTRL|wxCLRP_SHOW_LABEL );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText161 = new wxStaticText( colorPanel, wxID_STATIC, _("End"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  colourPickerGradientEnd = new wxColourPickerCtrl( colorPanel, ID_COLOURPICKER_GRADEND, wxColour(0, 0, 255), wxDefaultPosition, wxDefaultSize, wxCLRP_DEFAULT_STYLE|wxCLRP_USE_TEXTCTRL|wxCLRP_SHOW_LABEL );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText164 = new wxStaticText( colorPanel, wxID_STATIC, _("Low outliers"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  colourPickerGradientLow = new wxColourPickerCtrl( colorPanel, ID_COLOURPICKER_GRADLOW, wxColour(207, 207, 68), wxDefaultPosition, wxDefaultSize, wxCLRP_DEFAULT_STYLE|wxCLRP_USE_TEXTCTRL|wxCLRP_SHOW_LABEL );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxStaticText* itemStaticText167 = new wxStaticText( colorPanel, wxID_STATIC, _("High outliers"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  colourPickerGradientTop = new wxColourPickerCtrl( colorPanel, ID_COLOURPICKER_GRADTOP, wxColour(255, 146, 24), wxDefaultPosition, wxDefaultSize, wxCLRP_DEFAULT_STYLE|wxCLRP_USE_TEXTCTRL|wxCLRP_SHOW_LABEL );
  if (PreferencesDialog::ShowToolTips())
  ...
  wxButton* itemButton169 = new wxButton( colorPanel, ID_BUTTON_DEFAULT_GRADIENT, _("Default"), wxDefaultPosition, wxDefaultSize, 0 );
  if (PreferencesDialog::ShowToolTips())
  ...
  GetBookCtrl()->AddPage(colorPanel, _("Color"));

  workspacesPanel = new wxPanel( GetBookCtrl(), ID_WORKSPACES, wxDefaultPosition, wxDefaultSize, wxSUNKEN_BORDER|wxTAB_TRAVERSAL );
  wxBoxSizer* itemBoxSizer171 = new wxBoxSizer(wxHORIZONTAL);
  workspacesPanel->SetSizer(itemBoxSizer171);
  ...
  listWorkspaces = new wxListBox( workspacesPanel, ID_LISTBOX_WORKSPACES, wxDefaultPosition, wxDefaultSize, listWorkspacesStrings, wxLB_SINGLE|wxLB_HSCROLL );
  ...
  buttonAddWorkspace = new wxBitmapButton( workspacesPanel, ID_BUTTON_WORKSPACES_ADD, itemPropertySheetDialog1->GetBitmapResource(wxT("derived_add.xpm")), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW );
  itemBoxSizer174->Add(buttonAddWorkspace, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5);

  buttonDeleteWorkspace = new wxBitmapButton( workspacesPanel, ID_BUTTON_WORKSPACES_DELETE, itemPropertySheetDialog1->GetBitmapResource(wxT("delete.xpm")), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW );
  itemBoxSizer174->Add(buttonDeleteWorkspace, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5);

  buttonUpWorkspace = new wxBitmapButton( workspacesPanel, ID_BUTTON_WORKSPACES_UP, itemPropertySheetDialog1->GetBitmapResource(wxT("arrow_up.xpm")), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW );
  itemBoxSizer174->Add(buttonUpWorkspace, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5);

  buttonDownWorkspace = new wxBitmapButton( workspacesPanel, ID_BUTTON_WORKSPACES_DOWN, itemPropertySheetDialog1->GetBitmapResource(wxT("arrow_down.xpm")), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW );
  itemBoxSizer174->Add(buttonDownWorkspace, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5);

  wxStaticLine* itemStaticLine179 = new wxStaticLine( workspacesPanel, wxID_STATIC, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL );
  ...
  txtWorkspaceName = new wxTextCtrl( workspacesPanel, ID_TEXT_WORKSPACE_NAME, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
  itemBoxSizer181->Add(txtWorkspaceName, 1, wxGROW|wxRIGHT|wxTOP|wxBOTTOM, 5);

  wxStaticBox* itemStaticBoxSizer183Static = new wxStaticBox(workspacesPanel, wxID_ANY, _(" Hints "));
  ...
  listHintsWorkspace = new wxListBox( workspacesPanel, ID_LISTBOX_HINTS_WORKSPACE, wxDefaultPosition, wxDefaultSize, listHintsWorkspaceStrings, wxLB_SINGLE );
  ...
  buttonAddHint = new wxBitmapButton( workspacesPanel, ID_BUTTON_HINT_ADD, itemPropertySheetDialog1->GetBitmapResource(wxT("derived_add.xpm")), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW );
  itemBoxSizer186->Add(buttonAddHint, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5);

  buttonDeleteHint = new wxBitmapButton( workspacesPanel, ID_BUTTON_HINT_DELETE, itemPropertySheetDialog1->GetBitmapResource(wxT("delete.xpm")), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW );
  itemBoxSizer186->Add(buttonDeleteHint, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5);

  buttonUpHint = new wxBitmapButton( workspacesPanel, ID_BITMAP_HINT_UP, itemPropertySheetDialog1->GetBitmapResource(wxT("arrow_up.xpm")), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW );
  itemBoxSizer186->Add(buttonUpHint, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5);

  buttonDownHint = new wxBitmapButton( workspacesPanel, ID_BUTTON_HINT_DOWN, itemPropertySheetDialog1->GetBitmapResource(wxT("arrow_down.xpm")), wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW );
  ...
  wxStaticText* itemStaticText193 = new wxStaticText( workspacesPanel, wxID_STATIC, _("Path"), wxDefaultPosition, wxDefaultSize, 0 );
  itemBoxSizer192->Add(itemStaticText193, 0, wxALIGN_LEFT|wxALL, 5);

  itemBoxSizer192->Add(5, 5, 0, wxGROW|wxTOP|wxBOTTOM, 2);

  wxStaticText* itemStaticText195 = new wxStaticText( workspacesPanel, wxID_STATIC, _("Description"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  txtHintPath = new wxTextCtrl( workspacesPanel, ID_TEXTCTRL_WORKSPACE_HINT_PATH, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY );
  itemBoxSizer197->Add(txtHintPath, 1, wxGROW|wxTOP|wxBOTTOM, 5);

  fileBrowserHintPath = new FileBrowserButton( workspacesPanel, ID_FILE_BUTTON_WORKSPACE_HINT_PATH, _("Browse"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  txtHintDescription = new wxTextCtrl( workspacesPanel, ID_TEXTCTRL_WORKSPACE_HINT_DESCRIPTION, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
  itemBoxSizer200->Add(txtHintDescription, 1, wxGROW|wxRIGHT|wxTOP|wxBOTTOM, 5);

  GetBookCtrl()->AddPage(workspacesPanel, _("Workspaces"));
