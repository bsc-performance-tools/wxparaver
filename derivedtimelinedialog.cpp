...
////@begin DerivedTimelineDialog content construction
  ...
  wxGridSizer* itemGridSizer3 = new wxGridSizer(2, 2, 0, 0);
  itemBoxSizer2->Add(itemGridSizer3, 0, wxGROW|wxALL|wxADJUST_MINSIZE, 5);

  wxStaticText* itemStaticText4 = new wxStaticText( itemDialog1, wxID_STATIC, _("Top Compose 1"), wxDefaultPosition, wxDefaultSize, 0 );
  itemGridSizer3->Add(itemStaticText4, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

  wxArrayString widgetTopCompose1Strings;
  widgetTopCompose1 = new wxChoice( itemDialog1, ID_TOPCOMPOSE1, wxDefaultPosition, wxSize(180, -1), widgetTopCompose1Strings, wxFULL_REPAINT_ON_RESIZE );
  itemGridSizer3->Add(widgetTopCompose1, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

  wxStaticText* itemStaticText6 = new wxStaticText( itemDialog1, wxID_STATIC, _("Top Compose 2"), wxDefaultPosition, wxDefaultSize, 0 );
  itemGridSizer3->Add(itemStaticText6, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

  wxArrayString widgetTopCompose2Strings;
  widgetTopCompose2 = new wxChoice( itemDialog1, ID_TOPCOMPOSE2, wxDefaultPosition, wxSize(180, -1), widgetTopCompose2Strings, wxFULL_REPAINT_ON_RESIZE );
  itemGridSizer3->Add(widgetTopCompose2, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxALL, 5);
  ...
  wxGridSizer* itemGridSizer9 = new wxGridSizer(5, 2, 0, 0);
  itemBoxSizer2->Add(itemGridSizer9, 0, wxGROW|wxALL, 5);

  wxStaticText* itemStaticText10 = new wxStaticText( itemDialog1, wxID_STATIC, _("Factor"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  itemGridSizer9->Add(widgetFactorTimeline1, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

  wxStaticText* itemStaticText12 = new wxStaticText( itemDialog1, wxID_STATIC, _("Timeline"), wxDefaultPosition, wxDefaultSize, 0 );
  ...
  itemGridSizer9->Add(widgetTimelines1, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

  wxStaticText* itemStaticText14 = new wxStaticText( itemDialog1, wxID_STATIC, _("Operation"), wxDefaultPosition, wxDefaultSize, 0 );
  itemGridSizer9->Add(itemStaticText14, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

  wxArrayString widgetOperationsStrings;
  widgetOperations = new wxChoice( itemDialog1, ID_OPERATIONS, wxDefaultPosition, wxSize(180, -1), widgetOperationsStrings, wxFULL_REPAINT_ON_RESIZE );
  itemGridSizer9->Add(widgetOperations, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

  wxStaticText* itemStaticText16 = new wxStaticText( itemDialog1, wxID_STATIC, _("Timeline"), wxDefaultPosition, wxDefaultSize, 0 );
  itemGridSizer9->Add(itemStaticText16, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);
  ...
  itemGridSizer9->Add(widgetTimelines2, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

  wxStaticText* itemStaticText18 = new wxStaticText( itemDialog1, wxID_STATIC, _("Factor"), wxDefaultPosition, wxDefaultSize, 0 );
  itemGridSizer9->Add(itemStaticText18, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

  widgetFactorTimeline2 = new wxTextCtrl( itemDialog1, ID_FACTOR_TIMELINE_2, _("1.0"), wxDefaultPosition, wxDefaultSize, 0 );
  itemGridSizer9->Add(widgetFactorTimeline2, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxALL, 5);
  ...
  itemBoxSizer2->Add(itemStaticLine22, 0, wxGROW|wxALL, 5);
...
bool DerivedTimelineDialog::TransferDataToWindow()
{
  ...
  // Fill factor fields
  presetFactorFields( factorTimeline1, widgetFactorTimeline1 );
  presetFactorFields( factorTimeline2, widgetFactorTimeline2 );
...
void DerivedTimelineDialog::presetFactorFields( double value, wxTextCtrl *field )
{
  wxString auxFactor;
